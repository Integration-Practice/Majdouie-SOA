...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$header1" element="ns1:header" location="../ebo/util.cmn.EBMHeader_1.0.xsd" ::)
...
xf:util($header1,
    ...
    <con:dependency location="../ebo/util.flt.Fault_1.0.xsd">
        <con:schema ref="core/ebo/util.flt.Fault_1.0"/>
    </con:dependency>
</con:xqueryEntry>