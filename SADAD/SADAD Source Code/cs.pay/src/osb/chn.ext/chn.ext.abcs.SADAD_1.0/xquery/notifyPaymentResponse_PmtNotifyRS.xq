(:: pragma bea:global-element-parameter parameter="$notifyPaymentResponse1" element="ns2:notifyPaymentResponse" location="../../../core/ebs/cs.pay.ebs.Payments_1.0.xsd" ::)
...
xf:notifyPaymentResponse_PmtNotifyRS($notifyPaymentResponse1)
