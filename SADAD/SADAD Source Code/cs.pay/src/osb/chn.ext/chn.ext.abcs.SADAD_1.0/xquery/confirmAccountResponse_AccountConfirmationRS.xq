(:: pragma bea:global-element-parameter parameter="$confirmAccountResponse1" element="ns2:confirmAccountResponse" location="../../../core/ebs/cs.pay.ebs.Accounts_1.0.xsd" ::)
...
xf:confirmAccountResponse_AccountConfirmationRS($confirmAccountResponse1)