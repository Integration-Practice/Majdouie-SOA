(:: pragma bea:global-element-parameter parameter="$confirmBillResponse1" element="ns2:confirmBillResponse" location="../../../core/ebs/cs.pay.ebs.Bills_1.0.xsd" ::)
...
xf:confirmBillResponse_BillConfirmationRS($confirmBillResponse1)